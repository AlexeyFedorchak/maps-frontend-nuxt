...
var starsList = [];
// var constnameList = [];
// var boundarylineList = [];
// var constlineList = [];

var rotateCallback = null;

Celestial.rotateCallback = function(callback) {
  this.rotateCallback = callback;
};

Celestial.slowAnimations = function() {
  ANIMINTERVAL_R = 4000;
  ANIMINTERVAL_P = 5000;
  ANIMINTERVAL_Z = 2000;
};

Celestial.fastAnimations = function() {
  ANIMINTERVAL_R = 1000;
  ANIMINTERVAL_P = 1500;
  ANIMINTERVAL_Z = 750;
};
...
Celestial.display = function(config) {
  ...
  var paths = [
    new Path2D("M418.211,867.484c14.758,4.35,30.846,9.977,48.531,17.269c-17.652-7.279-33.057-14.604-46.6-21.9  c23.646-2.784,50.393-4.391,80.781-4.391c-30.422,0-57.201-1.602-80.873-4.406c13.533-7.352,28.947-14.749,46.6-22.096  c-17.627,7.336-33.658,12.999-48.369,17.398c14.721-18.671,32.49-38.697,53.959-60.163c-21.502,21.5-41.553,39.283-60.25,54.022  c4.355-14.763,9.963-30.834,17.27-48.523c-7.283,17.648-14.594,33.065-21.887,46.583c-2.805-23.64-4.391-50.382-4.391-80.771  c0,30.434-1.623,57.209-4.434,80.863c-7.334-13.51-14.723-28.927-22.093-46.589c7.343,17.633,13.019,33.656,17.417,48.373  c-18.681-14.729-38.699-32.493-60.165-53.959c21.5,21.5,39.28,41.546,54.028,60.249c-14.767-4.358-30.839-9.969-48.543-17.271  c17.651,7.277,33.07,14.604,46.592,21.896c-23.639,2.791-50.381,4.397-80.782,4.393c30.444,0.005,57.221,1.613,80.877,4.406  c-13.518,7.356-28.926,14.752-46.584,22.097c17.617-7.334,33.659-12.995,48.37-17.396c-14.73,18.669-32.492,38.694-53.958,60.161  c21.5-21.496,41.551-39.283,60.249-54.023c-4.365,14.765-9.977,30.839-17.271,48.528c7.267-17.653,14.595-33.068,21.89-46.585  c2.803,23.637,4.406,50.378,4.406,80.771c0-30.427,1.586-57.204,4.398-80.864c7.352,13.513,14.746,28.93,22.1,46.597  c-7.354-17.64-13.01-33.661-17.416-48.38c18.684,14.729,38.707,32.502,60.176,53.957  C450.738,906.23,432.957,886.181,418.211,867.484z"),
    new Path2D("M869.232,407.658c12.98-10.103,37.332-10.103,83.266-10.103c-45.934,0-70.285,0-83.266-10.061  c11.826-14.749,25.922-30.535,42.744-47.36c-16.822,16.825-32.57,30.924-47.355,42.751c-10.064-12.944-10.064-37.332-10.064-83.267  c0,45.935,0,70.322-10.102,83.267c-14.75-11.827-30.529-25.926-47.354-42.751c16.824,16.825,30.953,32.611,42.742,47.36  c-12.939,10.061-37.332,10.061-83.266,10.061c45.934,0,70.326,0,83.266,10.103c-11.789,14.748-25.918,30.536-42.742,47.359  c16.824-16.823,32.604-30.923,47.354-42.751c10.102,12.944,10.102,37.333,10.102,83.268c0-45.935,0-70.323,10.064-83.268  c14.785,11.828,30.533,25.928,47.355,42.751C895.154,438.194,881.059,422.406,869.232,407.658"),
    new Path2D("M82.03,301.56L91.29 352.49 142.23 361.76 91.29 371.02 82.03 421.95 72.77 371.02 21.83 361.76 72.77 352.49 z"),
    new Path2D("M82.03,301.56L91.29 352.49 142.23 361.76 91.29 371.02 82.03 421.95 72.77 371.02 21.83 361.76 72.77 352.49 z"),
    new Path2D("M82.03,301.56L91.29 352.49 142.23 361.76 91.29 371.02 82.03 421.95 72.77 371.02 21.83 361.76 72.77 352.49 z"),
    new Path2D("M82.03,301.56L91.29 352.49 142.23 361.76 91.29 371.02 82.03 421.95 72.77 371.02 21.83 361.76 72.77 352.49 z"),
    new Path2D("M693.82,10.36L707.36 47.4 744.39 60.94 707.36 74.48 693.82 111.52 680.27 74.48 643.24 60.94 680.27 47.4 z"),
    new Path2D("M545.45,9.55L549.59 49.86 583.68 27.97 554.75 56.33 593.13 69.34 552.91 64.41 566.67 102.52 545.45 68 524.23 102.52 537.98 64.41 497.77 69.34 536.14 56.33 507.21 27.97 541.31 49.86 z"),
    new Path2D("M545.45,9.55L549.59 49.86 583.68 27.97 554.75 56.33 593.13 69.34 552.91 64.41 566.67 102.52 545.45 68 524.23 102.52 537.98 64.41 497.77 69.34 536.14 56.33 507.21 27.97 541.31 49.86 z"),
    new Path2D("M545.45,9.55L549.59 49.86 583.68 27.97 554.75 56.33 593.13 69.34 552.91 64.41 566.67 102.52 545.45 68 524.23 102.52 537.98 64.41 497.77 69.34 536.14 56.33 507.21 27.97 541.31 49.86 z")
  ];

  var pathPositionCorrections = [
    [400.211, 853],
    [852.211, 395],
    [82.03, 360],
    [82.03, 360],
  ...
  function redraw() {
    ...
    var circleRadius = canvaswidth/2;

    if (cfg.stars.show) {
      var fillStyleColor = false;

      setStyle(cfg.stars.style);

      if(cfg.realisticStars) {

        if(cfg.glowingStars) {

          starsList.forEach(function(d) {
            if (d.properties.mag < 3.5 && clip(d.geometry.coordinates) && d.properties.mag <= cfg.stars.limit) {
              if(cfg.hideBottomStars == false || d.geometry.coordinates[1] > 5) {
                var pt = mapProjection(d.geometry.coordinates),
                    r = starSize(d);

                var scale = 0.015*r;

                var starDistanceFromCenter = Math.sqrt(Math.pow(pt[0]-circleRadius, 2) + Math.pow(pt[1]-circleRadius, 2));

                if((starDistanceFromCenter / circleRadius) > (1-0.007*r)) {
                  return;
                }
                ...
                var gradient_size = 1.2;
                if(d.properties.mag < 3.5) {
                  gradient_size = 1.6;
                }

                var fillStyleColor = starColor(d);

                fillStyleColor = colorShade(fillStyleColor, 50);

                var rgbColor = hexToRgb(fillStyleColor);

                context.save();
                context.beginPath();
                context.arc(pt[0], pt[1], gradient_size*r, 0, 2 * Math.PI);
                context.closePath();

                // var randomOpacityDecrease = 1- (Math.random() / 15);
                var randomOpacityDecrease = 1;
                var level1 = 1*randomOpacityDecrease;
                var level2 = 0.8*randomOpacityDecrease;
                var level3 = 0.62*randomOpacityDecrease;
                var level4 = 0.45*randomOpacityDecrease;
                var level5 = 0.29*randomOpacityDecrease;
                var level6 = 0.14*randomOpacityDecrease;

                var gradient = context.createRadialGradient(pt[0],pt[1],0, pt[0],pt[1],gradient_size*r);
                gradient.addColorStop(0, 'rgba('+rgbColor+','+level1+')');
                gradient.addColorStop(0.65, 'rgba('+rgbColor+','+level2+')');
                gradient.addColorStop(0.72, 'rgba('+rgbColor+','+level3+')');
                gradient.addColorStop(0.79, 'rgba('+rgbColor+','+level4+')');
                gradient.addColorStop(0.86, 'rgba('+rgbColor+','+level5+')');
                gradient.addColorStop(0.92, 'rgba('+rgbColor+','+level6+')');
          ...
          starsList.forEach(function(d){
            if (d.properties.mag >= 3.5 && clip(d.geometry.coordinates) && d.properties.mag <= cfg.stars.limit) {
              ...
              if(cfg.hideBottomStars == false || d.geometry.coordinates[1] > 5) {
                ...
                if((starDistanceFromCenter / circleRadius) > (1-0.01*r)) {
                  return;
                }
            ...
            if (clip(d.geometry.coordinates) && d.properties.mag <= cfg.stars.limit) {
              ...
              if(cfg.hideBottomStars == false || d.geometry.coordinates[1] > 5) {
                ...
                if(circleRadius > 1000) {
                  if((starDistanceFromCenter / circleRadius) > (1-0.012*r)) {
                    return;
                  }
                }
                else {
                  if((starDistanceFromCenter / circleRadius) > (1-0.02*r)) {
                    return;
                  }
                }
                ...
                if(d.properties.mag < 3 && !cfg.glowingStars) {
                  // var p = new Path2D("M418.211,867.484c14.758,4.35,30.846,9.977,48.531,17.269c-17.652-7.279-33.057-14.604-46.6-21.9  c23.646-2.784,50.393-4.391,80.781-4.391c-30.422,0-57.201-1.602-80.873-4.406c13.533-7.352,28.947-14.749,46.6-22.096  c-17.627,7.336-33.658,12.999-48.369,17.398c14.721-18.671,32.49-38.697,53.959-60.163c-21.502,21.5-41.553,39.283-60.25,54.022  c4.355-14.763,9.963-30.834,17.27-48.523c-7.283,17.648-14.594,33.065-21.887,46.583c-2.805-23.64-4.391-50.382-4.391-80.771  c0,30.434-1.623,57.209-4.434,80.863c-7.334-13.51-14.723-28.927-22.093-46.589c7.343,17.633,13.019,33.656,17.417,48.373  c-18.681-14.729-38.699-32.493-60.165-53.959c21.5,21.5,39.28,41.546,54.028,60.249c-14.767-4.358-30.839-9.969-48.543-17.271  c17.651,7.277,33.07,14.604,46.592,21.896c-23.639,2.791-50.381,4.397-80.782,4.393c30.444,0.005,57.221,1.613,80.877,4.406  c-13.518,7.356-28.926,14.752-46.584,22.097c17.617-7.334,33.659-12.995,48.37-17.396c-14.73,18.669-32.492,38.694-53.958,60.161  c21.5-21.496,41.551-39.283,60.249-54.023c-4.365,14.765-9.977,30.839-17.271,48.528c7.267-17.653,14.595-33.068,21.89-46.585  c2.803,23.637,4.406,50.378,4.406,80.771c0-30.427,1.586-57.204,4.398-80.864c7.352,13.513,14.746,28.93,22.1,46.597  c-7.354-17.64-13.01-33.661-17.416-48.38c18.684,14.729,38.707,32.502,60.176,53.957  C450.738,906.23,432.957,886.181,418.211,867.484z");
                  // var p = new Path2D("M869.232,407.658c12.98-10.103,37.332-10.103,83.266-10.103c-45.934,0-70.285,0-83.266-10.061  c11.826-14.749,25.922-30.535,42.744-47.36c-16.822,16.825-32.57,30.924-47.355,42.751c-10.064-12.944-10.064-37.332-10.064-83.267  c0,45.935,0,70.322-10.102,83.267c-14.75-11.827-30.529-25.926-47.354-42.751c16.824,16.825,30.953,32.611,42.742,47.36  c-12.939,10.061-37.332,10.061-83.266,10.061c45.934,0,70.326,0,83.266,10.103c-11.789,14.748-25.918,30.536-42.742,47.359  c16.824-16.823,32.604-30.923,47.354-42.751c10.102,12.944,10.102,37.333,10.102,83.268c0-45.935,0-70.323,10.064-83.268  c14.785,11.828,30.533,25.928,47.355,42.751C895.154,438.194,881.059,422.406,869.232,407.658");
                  // var p = new Path2D("M273.595,751.219c-37.839,37.822-72.851,68.403-105.104,92.875c-2.068,1.336-2.163,1.523-4.316,0  c-32.242-24.472-67.257-55.053-105.095-92.875c37.838,37.822,68.406,72.857,92.884,105.088c1.889,2.076,1.889,1.968,0,4.318  c-24.478,32.241-55.046,67.255-92.884,105.082c37.838-37.827,72.854-68.396,105.095-92.861c2.353-2.1,2.451-1.434,4.316,0  c32.254,24.465,67.266,55.034,105.104,92.861c-37.839-37.827-68.416-72.841-92.883-105.082c-1.992-2.166-1.905-2.166,0-4.318  C205.179,824.076,235.756,789.041,273.595,751.219z");

                  // //1st star variation
                  // context.save();
                  // context.fillStyle = fillStyleColor;
                  // context.transform(1, 0, 0, 1, pt[0] - 400.211*scale, pt[1] - 853*scale);
                  ...
                  // context.save();
                  // context.fillStyle = fillStyleColor;
                  // context.transform(1, 0, 0, 1, pt[0] - 852.211*scale, pt[1] - 395*scale);
                  // context.scale(scale, scale);
                  // context.stroke(p);
                  // context.fill(p);
                  // context.restore();
                  ...
                  // context.save();
                  // context.fillStyle = fillStyleColor;
                  // context.transform(1, 0, 0, 1, pt[0] - 166.211*scale, pt[1] - 865*scale);
                  // context.scale(scale, scale);
                  // context.stroke(p);
                  // context.fill(p);
                  // context.restore();
                  ...
                  var relativeMag = (d.properties.mag + 2)*(7/5);
                  relativeMag = Math.floor(relativeMag);

                  if(d.properties.mag > 1) {
                    scale = 0.03*r;
                  }

                  const pathToUse = paths[relativeMag];
                  var correctionToUse = pathPositionCorrections[relativeMag];

                  var shineScaleToUse = starScalings[relativeMag];

                  context.save();
                  context.fillStyle = fillStyleColor;
                  context.transform(1, 0, 0, 1, pt[0] - correctionToUse[0]*scale, pt[1] - correctionToUse[1]*scale);
                  context.scale(scale, scale);
                  context.stroke(pathToUse);
                  context.fill(pathToUse);
                  context.restore();

                  context.beginPath();
                  context.arc(pt[0], pt[1], 2*r*shineScaleToUse, 0, 2 * Math.PI);
                  context.closePath();

                  rgbColor = hexToRgb(fillStyleColor);

                  context.save();
                  gradient = context.createRadialGradient(pt[0],pt[1],0, pt[0],pt[1],2*r*shineScaleToUse);
                  gradient.addColorStop(0, 'rgba('+rgbColor+',0.45)');
                  gradient.addColorStop(0.5, 'rgba('+rgbColor+',0.25)');
                  gradient.addColorStop(1, 'rgba('+rgbColor+',0)');
                  context.fillStyle = gradient;
                  context.fill();
                  context.restore();
                  ...
                  context.save();
                  context.beginPath();
                  context.arc(pt[0], pt[1], 2.5*r, 0, 2 * Math.PI);
                  context.closePath();

                  gradient = context.createRadialGradient(pt[0],pt[1],0, pt[0],pt[1],2.5*r);
                  gradient.addColorStop(0, 'rgba('+rgbColor+',0.40)');
                  gradient.addColorStop(0.5, 'rgba('+rgbColor+',0.20)');
                  gradient.addColorStop(1, 'rgba('+rgbColor+',0)');
                  context.fillStyle = gradient;
                  context.fill();
                  context.restore();
  ...
  function drawOutline(stroke) {
    ...
    mapProjection.rotate(rot);
    if(typeof Celestial.rotateCallback === "function") {
      Celestial.rotateCallback(rot);
    }
  }
  ...
  function getWidth() {
    ...
    else w = document.getElementById('starmap-canvas').getBoundingClientRect().width - margin[0]*2;
...
var settings = { 
  ...
  realisticStars: false,        // Display realistic stars using SVG
  glowingStars: false,        // Display only glowing stars when using realistic stars
  hideBottomStars: false,        // Hide bottom stars, for displaying trees
